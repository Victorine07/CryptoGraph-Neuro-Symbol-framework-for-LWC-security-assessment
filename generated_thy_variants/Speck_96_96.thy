...
definition speck_encrypt_round :: "48 word ⇒ 48 word × 48 word ⇒ 48 word × 48 word" where
...
definition speck_decrypt_round_inverse :: "48 word ⇒ 48 word × 48 word ⇒ 48 word × 48 word" where
...
function speck_gen_key_schedule_rec :: "48 word list ⇒ 48 word list ⇒ nat ⇒ 48 word list" where
...
termination by (relation "measure (λ(l, k, i). 27 - i)") auto


definition speck_generate_key_schedule :: "48 word list ⇒ 48 word list" where
...
fun speck_encrypt_iterate :: "48 word × 48 word ⇒ 48 word list ⇒ 48 word × 48 word" where
  "speck_encrypt_iterate state [] = state"
| "speck_encrypt_iterate state (k#ks) = speck_encrypt_iterate (speck_encrypt_round k state) ks"


fun speck_decrypt_iterate :: "48 word × 48 word ⇒ 48 word list ⇒ 48 word × 48 word" where
  "speck_decrypt_iterate state ks = foldl (λst_new k. speck_decrypt_round_inverse k st_new) state (rev ks)"


definition speck_encrypt_block :: "48 word × 48 word ⇒ 48 word list ⇒ 48 word × 48 word" where
  "speck_encrypt_block state keys = speck_encrypt_iterate state keys"


definition speck_decrypt_block :: "48 word × 48 word ⇒ 48 word list ⇒ 48 word × 48 word" where
  "speck_decrypt_block state keys = speck_decrypt_iterate state keys"


definition speck_encrypt :: "96 word ⇒ 48 word list ⇒ 96 word" where
...
definition speck_decrypt :: "96 word ⇒ 48 word list ⇒ 96 word" where
