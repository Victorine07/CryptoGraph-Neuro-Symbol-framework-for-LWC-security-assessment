...
definition simon_z4 :: int where 
  "simon_z4 = 0b11110111001001010011000011101000000100011011010110011110001011"
...
function simon_gen_key_schedule_rec :: "64 word list ⇒ nat ⇒ 64 word list" where
  "simon_gen_key_schedule_rec ks i = (if i ≥ 72 then ks else
    let z_bit = bit 0b11110111001001010011000011101000000100011011010110011110001011 (i - 4);
