...
definition simeck_round_constants_sequence :: "bool list" where
  "simeck_round_constants_sequence = simeck_get_sequence_rec (44 - 6) 0 (replicate 6 True)"


definition simeck_F_function :: "32 word \<Rightarrow> 32 word" where
  "simeck_F_function x = xor (and x (word_rotl 5 x)) (word_rotl 1 x)"


definition simeck_encrypt_round :: "32 word \<Rightarrow> 32 word \<times> 32 word \<Rightarrow> 32 word \<times> 32 word" where
  "simeck_encrypt_round k xy = (
    let (left, right) = xy in 
    (xor (xor (simeck_F_function left) right) k, left))"


definition simeck_decrypt_round_inverse :: "32 word \<Rightarrow> 32 word \<times> 32 word \<Rightarrow> 32 word \<times> 32 word" where
...
definition simeck_key_schedule_constant :: "32 word" where
  "simeck_key_schedule_constant = 0xFFFFFFFC"


fun simeck_gen_key_schedule_rec :: "32 word list \<Rightarrow> bool list \<Rightarrow> 32 word list" where
...
definition simeck_generate_key_schedule :: "32 word list \<Rightarrow> 32 word list" where
  "simeck_generate_key_schedule initial_keys = 
     simeck_gen_key_schedule_rec initial_keys simeck_round_constants_sequence"


fun simeck_encrypt_iterate :: "32 word \<times> 32 word \<Rightarrow> 32 word list \<Rightarrow> 32 word \<times> 32 word" where
...
fun simeck_decrypt_iterate :: "32 word \<times> 32 word \<Rightarrow> 32 word list \<Rightarrow> 32 word \<times> 32 word" where
  "simeck_decrypt_iterate state ks = foldl (\<lambda>st_new k. simeck_decrypt_round_inverse k st_new) state (rev ks)"


definition simeck_encrypt_block :: "32 word \<times> 32 word \<Rightarrow> 32 word list \<Rightarrow> 32 word \<times> 32 word" where
  "simeck_encrypt_block plaintext keys = simeck_encrypt_iterate plaintext keys"


definition simeck_decrypt_block :: "32 word \<times> 32 word \<Rightarrow> 32 word list \<Rightarrow> 32 word \<times> 32 word" where
  "simeck_decrypt_block ciphertext keys = simeck_decrypt_iterate ciphertext keys"


definition simeck_encrypt :: "64 word \<Rightarrow> 32 word list \<Rightarrow> 64 word" where
...
definition simeck_decrypt :: "64 word \<Rightarrow> 32 word list \<Rightarrow> 64 word" where
