...
definition speck_encrypt_round :: "32 word ⇒ 32 word × 32 word ⇒ 32 word × 32 word" where
...
definition speck_decrypt_round_inverse :: "32 word ⇒ 32 word × 32 word ⇒ 32 word × 32 word" where
...
function speck_gen_key_schedule_rec :: "32 word list ⇒ 32 word list ⇒ nat ⇒ 32 word list" where
...
termination by (relation "measure (λ(l, k, i). 26 - i)") auto


definition speck_generate_key_schedule :: "32 word list ⇒ 32 word list" where
...
fun speck_encrypt_iterate :: "32 word × 32 word ⇒ 32 word list ⇒ 32 word × 32 word" where
  "speck_encrypt_iterate state [] = state"
| "speck_encrypt_iterate state (k#ks) = speck_encrypt_iterate (speck_encrypt_round k state) ks"


fun speck_decrypt_iterate :: "32 word × 32 word ⇒ 32 word list ⇒ 32 word × 32 word" where
  "speck_decrypt_iterate state ks = foldl (λst_new k. speck_decrypt_round_inverse k st_new) state (rev ks)"


definition speck_encrypt_block :: "32 word × 32 word ⇒ 32 word list ⇒ 32 word × 32 word" where
  "speck_encrypt_block state keys = speck_encrypt_iterate state keys"


definition speck_decrypt_block :: "32 word × 32 word ⇒ 32 word list ⇒ 32 word × 32 word" where
  "speck_decrypt_block state keys = speck_decrypt_iterate state keys"


definition speck_encrypt :: "64 word ⇒ 32 word list ⇒ 64 word" where
...
definition speck_decrypt :: "64 word ⇒ 32 word list ⇒ 64 word" where
