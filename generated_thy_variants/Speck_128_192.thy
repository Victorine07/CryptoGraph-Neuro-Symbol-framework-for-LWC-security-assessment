...
definition speck_encrypt_round :: "64 word ⇒ 64 word × 64 word ⇒ 64 word × 64 word" where
...
definition speck_decrypt_round_inverse :: "64 word ⇒ 64 word × 64 word ⇒ 64 word × 64 word" where
...
function speck_gen_key_schedule_rec :: "64 word list ⇒ 64 word list ⇒ nat ⇒ 64 word list" where
...
termination by (relation "measure (λ(l, k, i). 32 - i)") auto


definition speck_generate_key_schedule :: "64 word list ⇒ 64 word list" where
...
fun speck_encrypt_iterate :: "64 word × 64 word ⇒ 64 word list ⇒ 64 word × 64 word" where
  "speck_encrypt_iterate state [] = state"
| "speck_encrypt_iterate state (k#ks) = speck_encrypt_iterate (speck_encrypt_round k state) ks"


fun speck_decrypt_iterate :: "64 word × 64 word ⇒ 64 word list ⇒ 64 word × 64 word" where
  "speck_decrypt_iterate state ks = foldl (λst_new k. speck_decrypt_round_inverse k st_new) state (rev ks)"


definition speck_encrypt_block :: "64 word × 64 word ⇒ 64 word list ⇒ 64 word × 64 word" where
  "speck_encrypt_block state keys = speck_encrypt_iterate state keys"


definition speck_decrypt_block :: "64 word × 64 word ⇒ 64 word list ⇒ 64 word × 64 word" where
  "speck_decrypt_block state keys = speck_decrypt_iterate state keys"


definition speck_encrypt :: "128 word ⇒ 64 word list ⇒ 128 word" where
...
definition speck_decrypt :: "128 word ⇒ 64 word list ⇒ 128 word" where
