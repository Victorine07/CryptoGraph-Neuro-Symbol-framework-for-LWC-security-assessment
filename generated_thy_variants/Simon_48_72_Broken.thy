theory Simon_48_72_Broken
  imports "HOL-Library.Word" "HOL.Bit_Operations"
begin


definition simon_z0 :: int where "simon_z0 = 0b01100111000011010100100010111110110011100001101010010001011111"
...
function simon_gen_key_schedule_rec :: "24 word list ⇒ nat ⇒ 24 word list" where
  "simon_gen_key_schedule_rec ks i = (if i ≥ 12 then ks else
    let z_bit = bit 0b01100111000011010100100010111110110011100001101010010001011111 (i - 3);
...
termination by (relation "measure (λ(ks, i). 12 - i)") auto
