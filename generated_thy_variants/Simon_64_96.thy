...
function simon_gen_key_schedule_rec :: "32 word list ⇒ nat ⇒ 32 word list" where
  "simon_gen_key_schedule_rec ks i = (if i ≥ 42 then ks else
    let z_bit = bit 0b11001101101001111110001000010100011001001011000000111011110101 (i - 3);
