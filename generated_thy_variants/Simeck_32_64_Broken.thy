...
definition simeck_round_constants_sequence :: "bool list" where
  "simeck_round_constants_sequence = simeck_get_sequence_rec (32 - 5) 0 (replicate 5 True)"


definition simeck_F_function :: "16 word \<Rightarrow> 16 word" where
  "simeck_F_function x = xor (and x (word_rotl 5 x)) (word_rotl 1 x)"


definition simeck_encrypt_round :: "16 word \<Rightarrow> 16 word \<times> 16 word \<Rightarrow> 16 word \<times> 16 word" where
  "simeck_encrypt_round k xy = (
    let (left, right) = xy in 
    (xor (xor (simeck_F_function left) right) k, left))"


definition simeck_decrypt_round_inverse :: "16 word \<Rightarrow> 16 word \<times> 16 word \<Rightarrow> 16 word \<times> 16 word" where
...
definition simeck_key_schedule_constant :: "16 word" where
  "simeck_key_schedule_constant = 0xFFFC"


fun simeck_gen_key_schedule_rec :: "16 word list \<Rightarrow> bool list \<Rightarrow> 16 word list" where
...
definition simeck_generate_key_schedule :: "16 word list \<Rightarrow> 16 word list" where
  "simeck_generate_key_schedule initial_keys = 
     simeck_gen_key_schedule_rec initial_keys simeck_round_constants_sequence"


fun simeck_encrypt_iterate :: "16 word \<times> 16 word \<Rightarrow> 16 word list \<Rightarrow> 16 word \<times> 16 word" where
...
fun simeck_decrypt_iterate :: "16 word \<times> 16 word \<Rightarrow> 16 word list \<Rightarrow> 16 word \<times> 16 word" where
  "simeck_decrypt_iterate state ks = foldl (\<lambda>st_new k. simeck_decrypt_round_inverse k st_new) state (rev ks)"


definition simeck_encrypt_block :: "16 word \<times> 16 word \<Rightarrow> 16 word list \<Rightarrow> 16 word \<times> 16 word" where
  "simeck_encrypt_block plaintext keys = simeck_encrypt_iterate plaintext keys"


definition simeck_decrypt_block :: "16 word \<times> 16 word \<Rightarrow> 16 word list \<Rightarrow> 16 word \<times> 16 word" where
  "simeck_decrypt_block ciphertext keys = simeck_decrypt_iterate ciphertext keys"


definition simeck_encrypt :: "32 word \<Rightarrow> 16 word list \<Rightarrow> 32 word" where
...
definition simeck_decrypt :: "32 word \<Rightarrow> 16 word list \<Rightarrow> 32 word" where
